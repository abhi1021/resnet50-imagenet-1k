...
from .resnet50_pytorch import ResNet50PyTorch
...
MODELS = {
    ...
    'resnet50-pytorch': lambda num_classes=100: ResNet50PyTorch(num_classes=num_classes),
...
__all__ = ['get_model', 'list_models', 'WideResNet', 'ResNet50', 'ResNet50PyTorch']
